...
# Change directory to the jupyterlab_cell_layout directory
...
folder is located. Then you can remove the symlink named `jupyterlab-cell-layout` within that folder.
